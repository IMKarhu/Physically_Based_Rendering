...
GraphicsPipeLine::GraphicsPipeLine(Device* device, SwapChain* swapchain, Texture* texture)
    :m_Device(device),
...
void GraphicsPipeLine::createPipeLine(const VkDescriptorSetLayout& dslayout)
{
...
void GraphicsPipeLine::createRenderPass()
{
    ...
    depthAttachment.format = m_Texture->findDepthFormat(m_Device->getPhysicalDevice());
