...
namespace kge
{
	Device::Device(const VkInstance& instance, GLFWwindow* window, const bool& enableValidationLayers)
	{
    ...
    void Device::createSurface(const VkInstance& instance, GLFWwindow* window)
    {
	...
	void Device::createLogicalDevice(const bool& enableValidationLayers)
	{
    ...
    {
        vkUtils::QueueFamilyIndices indices = vkUtils::findQueueFamilies(pdevice, m_Surface);
